...
export default defineConfig({
	...
	env: {
		schema: {
			...
			QSTASH_CURRENT_SIGNING_KEY: envField.string({ context: "server", access: "secret" }),
			QSTASH_NEXT_SIGNING_KEY: envField.string({ context: "server", access: "secret" }),
			QSTASH_TOKEN: envField.string({ context: "server", access: "secret" }),
			QSTASH_URL: envField.string({ context: "server", access: "secret" }),
